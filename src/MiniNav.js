const MiniNav = () =>{
    return(
        ...
        <div className="container-xxl">
            ...
            <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mini-nav" aria-controls="mini-nav" aria-expanded="false" aria-label="Toggle navigation">
